        ...
        <div ref={scope} className="grid grid-cols-12 gap-2xl">
          ...
          <div className="col-span-12 lg:col-span-4">
            <div className="lg:sticky lg:top-[120px]">
              ...
              <div className="mt-2xl hidden items-start gap-lg lg:flex" aria-hidden>
                <span ref={counter} className="text-display-xl text-bronze leading-none">
                  01
                </span>
          ...
          <ol className="col-span-12 flex flex-col lg:col-span-8">
            {JOURNEY.map((item) => (
              ...
              >
                <span className="surface-faint spec-value col-span-2 text-body-sm group-data-[active=true]:text-bronze" data-spec>
                  {String(item.step).padStart(2, '0')}
                </span>
                <div className="col-span-10 flex flex-col gap-sm">
                  <h3 className="text-heading-lg transition-colors duration-base ease-house group-data-[active=true]:text-bronze">
                    {item.title}
                  </h3>
